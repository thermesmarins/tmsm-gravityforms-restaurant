 ...
 */
class Tmsm_Gravityforms_Restaurant_Posttypes {
	/**
	 * Register custom post type
	 *
	...
	public function create_custom_post_type() {
		...
		$post_types_fields = array(
			array(
				...
				'singular'    => __( 'Restaurant Closed', 'tmsm-gravityforms-restaurant' ),
				'plural'      => __( 'Restaurant Closed', 'tmsm-gravityforms-restaurant' ),
				'menu_name'   => __( 'Restaurant Closed', 'tmsm-gravityforms-restaurant' ),
				'description' => __( 'Restaurant Closed', 'tmsm-gravityforms-restaurant' ),
				'has_archive'           => false,
				'hierarchical'          => false,
